...
const AddCounselorFromUnitModal: React.FC<Props> = ({ isOpen, loading, onClose, onSave }) => {
      ...
      <div className="no-scrollbar relative w-full max-w-[500px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        <div className="px-2 pr-14">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Selecione o conselheiro e a unidade para associar ele a uma unidade
          </p>
        </div>
        ...
        <form className="flex flex-col">
          <div className="custom-scrollbar h-[300px] overflow-y-auto px-2 pb-3">
            ...
            <div className="mt-5">
              <Label>Selecione o Conselheiro</Label>
               <Select
                  options={userOptions}
        ...
        <div className="flex justify-end gap-3">
          ...
          <Button size="sm" onClick={handleSave}>
            {loading ? "Adicionando conselheiro..." : "Adicionar Conselheiro"}
          </Button>
        </div>
      </div>
    </Modal>
...
export default AddCounselorFromUnitModal;
