      ...
      >
        ...
        {topThree[1] ? (
          ...
          >
            ...
            >
              {topThree[1].individualRank.photoUrl ? (
                <img
                  src={topThree[1].individualRank.photoUrl}
                  alt={topThree[1].individualRank.name}
                ...
                <motion.div className="flex items-center justify-center w-full h-full text-lg sm:text-xl font-bold text-white bg-blue-500">
                  {topThree[1].individualRank.name.charAt(0)}
                </motion.div>
              )}
            </motion.div>
            <p className="text-xs font-medium text-center text-white truncate w-16 sm:w-20">{topThree[1].individualRank.name}</p>
            <motion.div 
        ...
        {topThree[0] ? (
          ...
          >
            ...
            >
              {topThree[0].individualRank.photoUrl ? (
                <img
                  src={topThree[0].individualRank.photoUrl}
                  alt={topThree[0].individualRank.name}
                  className="object-cover w-full h-full"
                />
              ) : (
                <motion.div className="flex items-center justify-center w-full h-full text-2xl font-bold text-white bg-blue-600">
                  {topThree[0].individualRank.name.charAt(0)}
                </motion.div>
              )}
            ...
            <p className="text-sm font-medium text-center text-white truncate w-20 sm:w-24">
              {topThree[0].individualRank.name}
            </p>
        ...
        {topThree[2] ? (
          ...
          >
            ...
            <motion.div 
              ...
              transition={{ duration: 2, repeat: Infinity }}
            >
              {topThree[2].individualRank.photoUrl ? (
                <img
                  src={topThree[2].individualRank.photoUrl}
                  alt={topThree[2].individualRank.name}
                  className="object-cover w-full h-full"
                />
              ) : (
                <motion.div className="flex items-center justify-center w-full h-full text-lg sm:text-xl font-bold text-white bg-blue-500">
                  {topThree[2].individualRank.name.charAt(0)}
                </motion.div>
              )}
            </motion.div>
            <p className="text-xs font-medium text-center text-white truncate w-16 sm:w-20">{topThree[2].individualRank.name}</p>
            <motion.div 
              className="flex items-center px-2 sm:px-3 py-1 mt-1 mb-3 text-xs font-bold text-blue-800 bg-white rounded-full"
              animate={{ scale: [1, 1.08, 1] }}
              transition={{ duration: 2, repeat: Infinity }}
...
export default PodiumIndividual;
